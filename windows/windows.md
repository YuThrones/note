...
## 字符转换问题
ANSI跟Unicode之间的转换，也就是char\* 跟wchar_t\* 之间的转换，可以通过 `WideCharToMultiByte` 和 `MultiByteToWideChar` 函数来解决，参考[http://www.cnblogs.com/gakusei/articles/1585211.html](http://www.cnblogs.com/gakusei/articles/1585211.html "WideCharToMultiByte和MultiByteToWideChar函数的用法")
