...
## 字符转换问题
ANSI跟Unicode之间的转换，也就是char\* 跟wchar_t\* 之间的转换，可以通过 `WideCharToMultiByte` 和 `MultiByteToWideChar` 函数来解决，参考[字符转换函数详解](http://www.cnblogs.com/gakusei/articles/1585211.html) 
